...
!function(t, e) {
    ...
    class Z extends H {
        ...
        pause(t) {
            t || (this._isPaused = !0),
            U.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (n(this._element),
            this.cycle(!0)),
        ...
        fn: function(t) {
            ...
            Object.keys(e.elements).forEach((function(t) {
                var i = e.styles[t] || {}
                  , n = e.attributes[t] || {}
                  , s = e.elements[t];
                pt(s) && dt(s) && (Object.assign(s.style, i),
        ...
        effect: function(t) {
            ...
            function() {
                Object.keys(e.elements).forEach((function(t) {
                    ...
                    pt(n) && dt(n) && (Object.assign(n.style, o),
    ...
    function kt(t) {
        ...
        return i && ("html" === dt(i) || "body" === dt(i) && "static" === Et(i).position) ? e : i || function(t) {
            ...
            if (-1 !== navigator.userAgent.indexOf("Trident") && pt(t) && "fixed" === Et(t).position)
                return null;
    ...
    var jt = {
        ...
        phase: "main",
        fn: function(t) {
            var e, i = t.state, n = t.name, s = t.options, o = i.elements.arrow, r = i.modifiersData.popperOffsets, a = _t(i.placement), l = Lt(a), c = [ot, st].indexOf(a) >= 0 ? "height" : "width";
            if (o && r) {
                var h = function(t, e) {
    ...
    function Bt(t) {
        ...
        }(r) : "function" == typeof h ? h(r) : r, u = d.x, f = void 0 === u ? 0 : u, p = d.y, m = void 0 === p ? 0 : p, g = r.hasOwnProperty("x"), _ = r.hasOwnProperty("y"), b = ot, v = it, y = window;
        if (c) {
            var w = kt(i)
              , E = "clientHeight"
              , A = "clientWidth";
            w === ut(i) && "static" !== Et(w = Tt(i)).position && "absolute" === a && (E = "scrollHeight",
            A = "scrollWidth"),
            w = w,
            s !== it && (s !== ot && s !== st || o !== at) || (v = nt,
            m -= w[E] - n.height,
            m *= l ? 1 : -1),
            s !== ot && (s !== it && s !== nt || o !== at) || (b = st,
            f -= w[A] - n.width,
            f *= l ? 1 : -1)
        }
    ...
    function Gt(t, e) {
        return "viewport" === e ? Qt(function(t) {
            ...
            var e, i = Tt(t), n = Vt(t), s = null == (e = t.ownerDocument) ? void 0 : e.body, o = xt(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), r = xt(i.scrollHeight, i.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), a = -n.scrollLeft + Kt(t), l = -n.scrollTop;
    ...
    function Zt(t) {
        var e, i = t.reference, n = t.element, s = t.placement, o = s ? _t(s) : null, r = s ? Mt(s) : null, a = i.x + i.width / 2 - n.width / 2, l = i.y + i.height / 2 - n.height / 2;
        switch (o) {
        case it:
            e = {
                x: a,
    ...
    function le(t, e, i) {
        ...
        pt(e) ? ((h = vt(e, !0)).x += e.clientLeft,
        h.y += e.clientTop) : a && (h.x = Kt(a))),
        {
    ...
    class Oe extends H {
        ...
        _completeHide(t) {
            P.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented || ("ontouchstart"in document.documentElement && [].concat(...document.body.children).forEach(t => P.off(t, "mouseover", h)),
            this._popper && this._popper.destroy(),
        ...
        static dataApiKeydownHandler(t) {
            if (/input|textarea/i.test(t.target.tagName) ? "Space" === t.key || "Escape" !== t.key && ("ArrowDown" !== t.key && "ArrowUp" !== t.key || t.target.closest(".dropdown-menu")) : !ge.test(t.key))
                return;
            ...
            if ("Escape" !== t.key)
                return "ArrowUp" === t.key || "ArrowDown" === t.key ? (e || n.show(),
    ...
    class Ce {
        ...
        _resetElementAttributes(t, e) {
            this._applyManipulationCallback(t, t => {
                ...
                void 0 === i ? t.style.removeProperty(e) : (F.removeDataAttribute(t, e),
                t.style[e] = i)
            }
            )
        }
    ...
    const Re = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"])
      ...
      , qe = (t, e) => {
        ...
        if (e.includes(i))
            return !Re.has(i) || Boolean(We.test(t.nodeValue) || ze.test(t.nodeValue));
    ...
    class Ye extends H {
        ...
        show() {
            ...
            if (t.defaultPrevented || !i)
                return;
            "tooltip" === this.constructor.NAME && this.tip && this.getTitle() !== this.tip.querySelector(".tooltip-inner").innerHTML && (this._disposePopper(),
            this.tip.remove(),
            this.tip = null);
        ...
        setElementContent(t, e) {
            if (null !== t)
                ...
                t.append(e)) : t.textContent = e.textContent)) : void (this._config.html ? (this._config.sanitize && (e = Fe(e, this._config.allowList, this._config.sanitizeFn)),
    ...
    class ni extends H {
        ...
        refresh() {
            ...
            U.find(ii, this._config.target).map(t => {
                const s = e(t)
                  , o = s ? U.findOne(s) : null;
                if (o) {
                    const t = o.getBoundingClientRect();
                    if (t.width || t.height)
                        return [F[i](o).top + n, s]
                }
                return null
            }
        ...
        _activate(t) {
            ...
            i.classList.contains("dropdown-item") ? U.findOne(".dropdown-toggle", i.closest(".dropdown")).classList.add("active") : U.parents(i, ".nav, .list-group").forEach(t => {
    ...
    class si extends H {
        ...
        _transitionComplete(t, e, i) {
            ...
            n && n.classList.contains("dropdown-menu")) {
                ...
                e && U.find(".dropdown-toggle", e).forEach(t => t.classList.add("active")),
    ...
    class ai extends H {
        ...
        hide() {
            this._element.classList.contains("show") && (P.trigger(this._element, "hide.bs.toast").defaultPrevented || (this._element.classList.add("showing"),
            this._queueCallback( () => {
...
!function(e) {
    ...
    r.prototype.displayEntryCaption = function(t) {
        ...
        if (null !== i && this.settings.captions) {
            ...
            if (null === e) {
                ...
                this.isValidCaption(s) && (e = l('<div class="caption">' + s + "</div>"),
                t.append(e),
    ...
    r.prototype.prepareBuildingRow = function(t) {
        var i, e, s, n, r, o = !0, a = 0, h = this.galleryWidth - 2 * this.border - (this.buildingRow.entriesBuff.length - 1) * this.settings.margins, g = h / this.buildingRow.aspectRatio, l = this.settings.rowHeight, d = this.buildingRow.width / h > this.settings.justifyThreshold;
        if (t && "hide" === this.settings.lastRow && !d) {
            for (i = 0; i < this.buildingRow.entriesBuff.length; i++)
                e = this.buildingRow.entriesBuff[i],
                this.settings.cssAnimation ? e.removeClass("jg-entry-visible") : (e.stop().fadeTo(0, .1),
                e.find("> img, > a > img").fadeTo(0, 0));
            return -1
        }
        for (t && !d && "justify" !== this.settings.lastRow && "hide" !== this.settings.lastRow && (o = !1,
        0 < this.rows && (o = (l = (this.offY - this.border - this.settings.margins * this.rows) / this.rows) * this.buildingRow.aspectRatio / h > this.settings.justifyThreshold)),
        i = 0; i < this.buildingRow.entriesBuff.length; i++)
            s = (e = this.buildingRow.entriesBuff[i]).data("jg.width") / e.data("jg.height"),
            o ? (n = i === this.buildingRow.entriesBuff.length - 1 ? h : g * s,
            r = g) : (n = l * s,
            r = l),
            h -= Math.round(n),
    ...
    r.prototype.updateEntries = function(t) {
        var i;
        return t && null != this.lastFetchedEntry ? i = l(this.lastFetchedEntry).nextAll(this.settings.selector).toArray() : (this.entries = [],
        i = this.getAllEntries()),
        0 < i.length && (l.isFunction(this.settings.sort) ? i = this.sortArray(i) : this.settings.randomize && (i = this.shuffleArray(i)),
    ...
    r.prototype.analyzeImages = function(t) {
        for (var i = this.lastAnalyzedIndex + 1; i < this.entries.length; i++) {
            ...
            if (!0 === e.data("jg.loaded") || "skipped" === e.data("jg.loaded")) {
                ...
                s / (this.buildingRow.aspectRatio + n) < this.settings.rowHeight && (this.flushRow(!1),
...
(function(a) {
    ...
    a.fn.paroller = function(h) {
        ...
        this.each(function() {
            ...
            'background' === v ? 'vertical' === w ? e.bgVertical(k, y) : 'horizontal' === w && e.bgHorizontal(k, y) : 'foreground' === v && ('vertical' === w ? e.vertical(k, z, u, t) : 'horizontal' === w && e.horizontal(k, z, u, t)),
            a(window).on('resize', function() {
                ...
                c = !0),
                'background' === v ? (g.background(k),
                'vertical' === w ? e.bgVertical(k, y) : 'horizontal' === w && e.bgHorizontal(k, y)) : 'foreground' === v && o <= j && (g.foreground(k),
                'vertical' === w ? e.vertical(k, q, u) : 'horizontal' === w && e.horizontal(k, q, u))
            }),
            a(window).on('load scroll', function() {
                ...
                c || (window.requestAnimationFrame(d),
                c = !0),
                'background' === v ? 'vertical' === w ? e.bgVertical(k, y) : 'horizontal' === w && e.bgHorizontal(k, y) : 'foreground' === v && g <= j && ('vertical' === w ? e.vertical(k, q, u, t) : 'horizontal' === w && e.horizontal(k, q, u, t))
            })
        })
    }
});
...
jQuery(document).ready((function(s) {
    ...
    function d(s) {
        ...
        if (s.parents(".cd-headline").hasClass("type")) {
            ...
            r(s.find("i").eq(0), s, a, 50),
            o(i.find("i").eq(0), i, a, 50)
        } else
            s.parents(".cd-headline").hasClass("clip") ? s.parents(".cd-words-wrapper").animate({
                width: "2px"
            }, 600, (function() {
                h(s, i),
                l(i)
            }
            )) : s.parents(".cd-headline").hasClass("loading-bar") ? (s.parents(".cd-words-wrapper").removeClass("is-loading"),
            h(s, i),
            setTimeout((function() {
                d(i)
            }
    ...
    function l(s, i) {
        s.parents(".cd-headline").hasClass("type") ? (o(s.find("i").eq(0), s, !1, i),
        s.addClass("is-visible").removeClass("is-hidden")) : s.parents(".cd-headline").hasClass("clip") && s.parents(".cd-words-wrapper").animate({
            width: s.width() + 10
        }, 600, (function() {
            setTimeout((function() {
                d(s)
    ...
    function r(i, e, a, t) {
        if (i.removeClass("in").addClass("out"),
